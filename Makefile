...
test:
	...
	$(CC) $(code_folder)$(client) $(CFLAGS) $(test_folder)$(client_folder)1/$(spacer)peer_server
	$(CC) $(code_folder)$(client) $(CFLAGS) $(test_folder)$(client_folder)1/$(spacer)peer_client
	...
	$(CC) $(code_folder)$(client) $(CFLAGS) $(test_folder)$(client_folder)2/$(spacer)peer_server
	$(CC) $(code_folder)$(client) $(CFLAGS) $(test_folder)$(client_folder)2/$(spacer)peer_client
	...
	$(CC) $(code_folder)$(client) $(CFLAGS) $(test_folder)$(client_folder)3/$(spacer)peer_server
	$(CC) $(code_folder)$(client) $(CFLAGS) $(test_folder)$(client_folder)3/$(spacer)peer_client
